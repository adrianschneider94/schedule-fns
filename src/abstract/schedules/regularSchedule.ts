...
export type RegularSchedule<DT, I, D> = (this: ScheduleFnsLibrary<DT, I, D>, oneStartMoment: DT, duration: D, period: D) => Schedule<DT, I, D>
...
export const RegularSchedule =
    function <DT, I, D>(this: ScheduleFnsLibrary<DT, I, D>, oneStartMoment: DT, duration: D, period: D): Schedule<DT, I, D> {
        let generator: Schedule<DT, I, D> = function* (this: ScheduleFnsLibrary<DT, I, D>, startDate, direction = "forward") {
            ...
            if (oneStartMoment <= startDate) {
                let intervalToSkip = this.createInterval(oneStartMoment, startDate)
                let timeToStartMoment = this.intervalToMilliseconds(intervalToSkip)
